...
<body>
    <div id = "wrapper">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $query = "SELECT D_Name,Type,Price FROM Drink WHERE Type = 'Original Taste Tea Series'";
    ...
    <div id = "right" style = "text-align:center">
            ...
            <div class="drink"><a href="FruitTea.php"><br>Fruit Tea </a><br></div>
            <div class="drink"><a><br>→ Original Taste Tea <br></a></div>
